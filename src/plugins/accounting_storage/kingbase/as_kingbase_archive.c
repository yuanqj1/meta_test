/*****************************************************************************\
 *  as_kingbase_archive.c - functions dealing with the archiving.
 *****************************************************************************
...
static uint32_t _archive_table(purge_type_t type, kingbase_conn_t *kingbase_conn,
...
static buf_t *_pack_archive_events(KCIResult *result, char *cluster_name,
				...
				time_t *period_start)
{
	...
	for(i=0;i<cnt;i++) {
		if (period_start && !*period_start)
			*period_start = slurm_atoul(KCIResultGetColumnValue(result,i,EVENT_REQ_START));

		memset(&event, 0, sizeof(local_event_t));

		event.cluster_nodes = KCIResultGetColumnValue(result,i,EVENT_REQ_CNODES);
		event.extra = KCIResultGetColumnValue(result,i,EVENT_REQ_EXTRA);
		event.instance_id = KCIResultGetColumnValue(result,i,EVENT_REQ_INSTANCE_ID);
		event.instance_type = KCIResultGetColumnValue(result,i,EVENT_REQ_INSTANCE_TYPE);
		event.node_name = KCIResultGetColumnValue(result,i,EVENT_REQ_NODE);
		event.period_end = KCIResultGetColumnValue(result,i,EVENT_REQ_END);
		event.period_start = KCIResultGetColumnValue(result,i,EVENT_REQ_START);
		event.reason = KCIResultGetColumnValue(result,i,EVENT_REQ_REASON);
		event.reason_uid = KCIResultGetColumnValue(result,i,EVENT_REQ_REASON_UID);
		event.state = KCIResultGetColumnValue(result,i,EVENT_REQ_STATE);
		event.tres_str = KCIResultGetColumnValue(result,i,EVENT_REQ_TRES);
...
static buf_t *_pack_archive_jobs(KCIResult *result, char *cluster_name,
				 uint32_t cnt, uint32_t usage_info,
				 time_t *period_start)
{
	int i = 0;
	...
	for (i = 0; i < cnt; i++) {
		if (period_start && !*period_start)
			*period_start = slurm_atoul(KCIResultGetColumnValue(result,i,JOB_REQ_SUBMIT));

		memset(&job, 0, sizeof(local_job_t));

		job.account = KCIResultGetColumnValue(result,i,JOB_REQ_ACCOUNT);//0
		job.admin_comment = KCIResultGetColumnValue(result,i,JOB_REQ_ADMIN_COMMENT);//1
		job.alloc_nodes = KCIResultGetColumnValue(result,i,JOB_REQ_ALLOC_NODES);
		job.associd = KCIResultGetColumnValue(result,i,JOB_REQ_ASSOCID);
		job.array_jobid = KCIResultGetColumnValue(result,i,JOB_REQ_ARRAYJOBID);
		job.array_max_tasks = KCIResultGetColumnValue(result,i,JOB_REQ_ARRAY_MAX);
		job.array_taskid = KCIResultGetColumnValue(result,i,JOB_REQ_ARRAYTASKID);
		job.array_task_pending = KCIResultGetColumnValue(result,i,JOB_REQ_ARRAY_TASK_PENDING);
		job.array_task_str = KCIResultGetColumnValue(result,i,JOB_REQ_ARRAY_TASK_STR);
		job.script_hash_inx = KCIResultGetColumnValue(result,i,JOB_REQ_SCRIPT_HASH_INX);
		job.blockid = KCIResultGetColumnValue(result,i,JOB_REQ_BLOCKID);
		job.constraints = KCIResultGetColumnValue(result,i,JOB_REQ_CONSTRAINTS);
		job.container = KCIResultGetColumnValue(result,i,JOB_REQ_CONTAINER);
		job.deleted = KCIResultGetColumnValue(result,i,JOB_REQ_DELETED);
		job.derived_ec = KCIResultGetColumnValue(result,i,JOB_REQ_DERIVED_EC);
		job.derived_es = KCIResultGetColumnValue(result,i,JOB_REQ_DERIVED_ES);
		job.env_hash_inx = KCIResultGetColumnValue(result,i,JOB_REQ_ENV_HASH_INX);
		job.exit_code = KCIResultGetColumnValue(result,i,JOB_REQ_EXIT_CODE);
		job.extra = KCIResultGetColumnValue(result,i,JOB_REQ_EXTRA);
		job.flags = KCIResultGetColumnValue(result,i,JOB_REQ_FLAGS);
		job.timelimit = KCIResultGetColumnValue(result,i,JOB_REQ_TIMELIMIT);
		job.eligible = KCIResultGetColumnValue(result,i,JOB_REQ_ELIGIBLE);
		job.end = KCIResultGetColumnValue(result,i,JOB_REQ_END);
		job.gid = KCIResultGetColumnValue(result,i,JOB_REQ_GID);
		job.gres_used = KCIResultGetColumnValue(result,i,JOB_REQ_GRES_USED);
		job.het_job_id = KCIResultGetColumnValue(result,i,JOB_REQ_HET_JOB_ID);
		job.het_job_offset = KCIResultGetColumnValue(result,i,JOB_REQ_HET_JOB_OFFSET);
		job.job_db_inx = KCIResultGetColumnValue(result,i,JOB_REQ_DB_INX);
		job.jobid = KCIResultGetColumnValue(result,i,JOB_REQ_JOBID);
		job.kill_requid = KCIResultGetColumnValue(result,i,JOB_REQ_KILL_REQUID);
		job.licenses = KCIResultGetColumnValue(result,i,JOB_REQ_LICENSES);
		job.mcs_label = KCIResultGetColumnValue(result,i,JOB_REQ_MCS_LABEL);
		job.mod_time = KCIResultGetColumnValue(result,i,JOB_REQ_MOD_TIME);
		job.name = KCIResultGetColumnValue(result,i,JOB_REQ_NAME);
		job.nodelist = KCIResultGetColumnValue(result,i,JOB_REQ_NODELIST);
		job.node_inx = KCIResultGetColumnValue(result,i,JOB_REQ_NODE_INX);
		job.partition = KCIResultGetColumnValue(result,i,JOB_REQ_PARTITION);
		job.priority = KCIResultGetColumnValue(result,i,JOB_REQ_PRIORITY);
		job.qos = KCIResultGetColumnValue(result,i,JOB_REQ_QOS);
		job.req_cpus = KCIResultGetColumnValue(result,i,JOB_REQ_REQ_CPUS);
		job.req_mem = KCIResultGetColumnValue(result,i,JOB_REQ_REQ_MEM);
		job.resvid = KCIResultGetColumnValue(result,i,JOB_REQ_RESVID);
		job.start = KCIResultGetColumnValue(result,i,JOB_REQ_START);
		job.state = KCIResultGetColumnValue(result,i,JOB_REQ_STATE);
		job.state_reason_prev = KCIResultGetColumnValue(result,i,JOB_REQ_STATE_REASON);
		job.std_err = KCIResultGetColumnValue(result,i,JOB_REQ_STDERR);
		job.std_in = KCIResultGetColumnValue(result,i,JOB_REQ_STDIN);
		job.std_out = KCIResultGetColumnValue(result,i,JOB_REQ_STDOUT);
		job.submit = KCIResultGetColumnValue(result,i,JOB_REQ_SUBMIT);
		job.submit_line = KCIResultGetColumnValue(result,i,JOB_REQ_SUBMIT_LINE);
		job.suspended = KCIResultGetColumnValue(result,i,JOB_REQ_SUSPENDED);
		job.system_comment = KCIResultGetColumnValue(result,i,JOB_REQ_SYSTEM_COMMENT);
		job.tres_alloc_str = KCIResultGetColumnValue(result,i,JOB_REQ_TRESA);
		job.tres_req_str = KCIResultGetColumnValue(result,i,JOB_REQ_TRESR);
		job.uid = KCIResultGetColumnValue(result,i,JOB_REQ_UID);
		job.wckey = KCIResultGetColumnValue(result,i,JOB_REQ_WCKEY);
		job.wckey_id = KCIResultGetColumnValue(result,i,JOB_REQ_WCKEYID);
		job.work_dir = KCIResultGetColumnValue(result,i,JOB_REQ_WORK_DIR);
...
static buf_t *_pack_archive_job_env(KCIResult *result, char *cluster_name,
				    uint32_t cnt, uint32_t usage_info,
				    time_t *period_start)
{
	int i = 0;
	...
	for (i = 0; i < cnt; i++) {
		...
		job.hash_inx = KCIResultGetColumnValue(result,i,JOB_ENV_HASH_INX);
		job.last_used = KCIResultGetColumnValue(result,i,JOB_ENV_LAST_USED);
		job.env_hash = KCIResultGetColumnValue(result,i,JOB_ENV_ENV_HASH);
		job.env_vars = KCIResultGetColumnValue(result,i,JOB_ENV_ENV_VARS);
...
static buf_t *_pack_archive_job_script(KCIResult *result, char *cluster_name,
				       uint32_t cnt, uint32_t usage_info,
				       time_t *period_start)
{
	int i = 0;
	...
	for (i = 0; i < cnt; i++) {
		...
		job.hash_inx = KCIResultGetColumnValue(result,i,JOB_SCRIPT_HASH_INX);
		job.last_used = KCIResultGetColumnValue(result,i,JOB_SCRIPT_LAST_USED);
		job.script_hash = KCIResultGetColumnValue(result,i,JOB_SCRIPT_SCRIPT_HASH);
		job.batch_script = KCIResultGetColumnValue(result,i,JOB_SCRIPT_BATCH_SCRIPT);
...
{  
	...
	for (i = 0; i < cnt; i++) {  
		...
		app.job_db_inx = KCIResultGetColumnValue(result, i, JOB_APP_DB_INX);  
		app.app_name = KCIResultGetColumnValue(result, i, JOB_APP_APP_NAME);  
		app.app_version = KCIResultGetColumnValue(result, i, JOB_APP_APP_VERSION);  
		app.app_runtime = KCIResultGetColumnValue(result, i, JOB_APP_APP_RUNTIME);  
		app.app_source = KCIResultGetColumnValue(result, i, JOB_APP_APP_SOURCE);  
		app.mod_time = KCIResultGetColumnValue(result, i, JOB_APP_MOD_TIME);  
		app.extra = KCIResultGetColumnValue(result, i, JOB_APP_EXTRA);  
		app.deleted = KCIResultGetColumnValue(result, i, JOB_APP_DELETED);  
...
static buf_t *_pack_archive_resvs(KCIResult *result, char *cluster_name,
				  uint32_t cnt, uint32_t usage_info,
				  time_t *period_start)
{
	int i = 0;
	...
	for (i = 0; i < cnt; i++) {
		if (period_start && !*period_start)
			*period_start = slurm_atoul(KCIResultGetColumnValue(result,i,RESV_REQ_START));

		memset(&resv, 0, sizeof(local_resv_t));

		resv.assocs = KCIResultGetColumnValue(result,i,RESV_REQ_ASSOCS);
		resv.deleted = KCIResultGetColumnValue(result,i,RESV_REQ_DELETED);
		resv.flags = KCIResultGetColumnValue(result,i,RESV_REQ_FLAGS);
		resv.id = KCIResultGetColumnValue(result,i,RESV_REQ_ID);
		resv.name = KCIResultGetColumnValue(result,i,RESV_REQ_NAME);
		resv.nodes = KCIResultGetColumnValue(result,i,RESV_REQ_NODES);
		resv.node_inx = KCIResultGetColumnValue(result,i,RESV_REQ_NODE_INX);
		resv.time_end = KCIResultGetColumnValue(result,i,RESV_REQ_END);
		resv.time_start = KCIResultGetColumnValue(result,i,RESV_REQ_START);
		resv.tres_str = KCIResultGetColumnValue(result,i,RESV_REQ_TRES);
		resv.unused_wall = KCIResultGetColumnValue(result,i,RESV_REQ_UNUSED);
		resv.comment = KCIResultGetColumnValue(result,i,RESV_REQ_COMMENT);
...
static buf_t *_pack_archive_steps(KCIResult *result, char *cluster_name,
				  uint32_t cnt, uint32_t usage_info,
				  time_t *period_start)
{
	int i = 0;
	...
	for (i = 0; i < cnt; i++) {
		if (period_start && !*period_start)
			*period_start = slurm_atoul(KCIResultGetColumnValue(result,i,STEP_REQ_START));

		memset(&step, 0, sizeof(local_step_t));

		step.act_cpufreq = KCIResultGetColumnValue(result,i,STEP_REQ_ACT_CPUFREQ);
		step.deleted = KCIResultGetColumnValue(result,i,STEP_REQ_DELETED);
		step.consumed_energy = KCIResultGetColumnValue(result,i,STEP_REQ_CONSUMED_ENERGY);
		step.container = KCIResultGetColumnValue(result,i,STEP_REQ_CONTAINER);
		step.exit_code = KCIResultGetColumnValue(result,i,STEP_REQ_EXIT_CODE);
		step.job_db_inx = KCIResultGetColumnValue(result,i,STEP_REQ_DB_INX);
		step.kill_requid = KCIResultGetColumnValue(result,i,STEP_REQ_KILL_REQUID);
		step.name = KCIResultGetColumnValue(result,i,STEP_REQ_NAME);
		step.nodelist = KCIResultGetColumnValue(result,i,STEP_REQ_NODELIST);
		step.nodes = KCIResultGetColumnValue(result,i,STEP_REQ_NODES);
		step.node_inx = KCIResultGetColumnValue(result,i,STEP_REQ_NODE_INX);
		step.period_end = KCIResultGetColumnValue(result,i,STEP_REQ_END);
		step.period_start = KCIResultGetColumnValue(result,i,STEP_REQ_START);
		step.period_suspended = KCIResultGetColumnValue(result,i,STEP_REQ_SUSPENDED);
		step.req_cpufreq_min = KCIResultGetColumnValue(result,i,STEP_REQ_REQ_CPUFREQ_MIN);
		step.req_cpufreq_max = KCIResultGetColumnValue(result,i,STEP_REQ_REQ_CPUFREQ_MAX);
		step.req_cpufreq_gov = KCIResultGetColumnValue(result,i,STEP_REQ_REQ_CPUFREQ_GOV);
		step.state = KCIResultGetColumnValue(result,i,STEP_REQ_STATE);
		step.stepid = KCIResultGetColumnValue(result,i,STEP_REQ_STEPID);
		step.step_het_comp = KCIResultGetColumnValue(result,i,STEP_REQ_STEP_HET_COMP);
		step.submit_line = KCIResultGetColumnValue(result,i,STEP_REQ_SUBMIT_LINE);
		step.sys_sec = KCIResultGetColumnValue(result,i,STEP_REQ_SYS_SEC);
		step.sys_usec = KCIResultGetColumnValue(result,i,STEP_REQ_SYS_USEC);
		step.tasks = KCIResultGetColumnValue(result,i,STEP_REQ_TASKS);
		step.task_dist = KCIResultGetColumnValue(result,i,STEP_REQ_TASKDIST);
		step.tres_alloc_str = KCIResultGetColumnValue(result,i,STEP_REQ_TRES);
		step.tres_usage_in_ave = KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_IN_AVE);
		step.tres_usage_in_max = KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_IN_MAX);
		step.tres_usage_in_max_nodeid =
			KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_IN_MAX_NODEID);
		step.tres_usage_in_max_taskid =
			KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_IN_MAX_TASKID);
		step.tres_usage_in_min = KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_IN_MIN);
		step.tres_usage_in_min_nodeid =
			KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_IN_MIN_NODEID);
		step.tres_usage_in_min_taskid =
			KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_IN_MIN_TASKID);
		step.tres_usage_in_tot = KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_IN_TOT);
		step.tres_usage_out_ave = KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_OUT_AVE);
		step.tres_usage_out_max = KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_OUT_MAX);
		step.tres_usage_out_max_nodeid =
			KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_OUT_MAX_NODEID);
		step.tres_usage_out_max_taskid =
			KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_OUT_MAX_TASKID);
		step.tres_usage_out_min = KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_OUT_MAX);
		step.tres_usage_out_min_nodeid =
			KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_OUT_MIN_NODEID);
		step.tres_usage_out_min_taskid =
			KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_OUT_MIN_TASKID);
		step.tres_usage_out_tot = KCIResultGetColumnValue(result,i,STEP_TRES_USAGE_OUT_TOT);
		step.user_sec = KCIResultGetColumnValue(result,i,STEP_REQ_USER_SEC);
		step.user_usec = KCIResultGetColumnValue(result,i,STEP_REQ_USER_USEC);
...
static buf_t *_pack_archive_suspends(KCIResult *result, char *cluster_name,
				     uint32_t cnt, uint32_t usage_info,
				     time_t *period_start)
{
	int i = 0;
	...
	for (i = 0; i < cnt; i++) {
		if (period_start && !*period_start)
			*period_start = slurm_atoul(KCIResultGetColumnValue(result,i,SUSPEND_REQ_START));

		memset(&suspend, 0, sizeof(local_suspend_t));

		suspend.job_db_inx = KCIResultGetColumnValue(result,i,SUSPEND_REQ_DB_INX);
		suspend.associd = KCIResultGetColumnValue(result,i,SUSPEND_REQ_ASSOCID);
		suspend.period_start = KCIResultGetColumnValue(result,i,SUSPEND_REQ_START);
		suspend.period_end = KCIResultGetColumnValue(result,i,SUSPEND_REQ_END);
...
static buf_t *_pack_archive_txns(KCIResult *result, char *cluster_name,
				 uint32_t cnt, uint32_t usage_info,
				 time_t *period_start)
{
	int i = 0;
	...
	for (i = 0; i < cnt; i++) {
		if (period_start && !*period_start)
			*period_start = slurm_atoul(KCIResultGetColumnValue(result,i,TXN_REQ_TS));

		memset(&txn, 0, sizeof(local_txn_t));

		txn.id = KCIResultGetColumnValue(result,i,TXN_REQ_ID);
		txn.timestamp = KCIResultGetColumnValue(result,i,TXN_REQ_TS);
		txn.action = KCIResultGetColumnValue(result,i,TXN_REQ_ACTION);
		txn.name = KCIResultGetColumnValue(result,i,TXN_REQ_NAME);
		txn.actor = KCIResultGetColumnValue(result,i,TXN_REQ_ACTOR);
		txn.info = KCIResultGetColumnValue(result,i,TXN_REQ_INFO);
		txn.cluster = KCIResultGetColumnValue(result,i,TXN_REQ_CLUSTER);
...
static buf_t *_pack_archive_usage(KCIResult *result, char *cluster_name,
				  uint32_t cnt, uint32_t usage_info,
				  time_t *period_start)
{
	int i = 0;
	...
	for (i = 0; i < cnt; i++) {
		if (period_start && !*period_start)
			*period_start = slurm_atoul(KCIResultGetColumnValue(result,i,USAGE_START));

		memset(&usage, 0, sizeof(local_usage_t));

		usage.id = KCIResultGetColumnValue(result,i,USAGE_ID);
		usage.tres_id = KCIResultGetColumnValue(result,i,USAGE_TRES);
		usage.time_start = KCIResultGetColumnValue(result,i,USAGE_START);
		usage.alloc_secs = KCIResultGetColumnValue(result,i,USAGE_ALLOC);
		usage.creation_time = KCIResultGetColumnValue(result,i,USAGE_CREATION_TIME);
		usage.mod_time = KCIResultGetColumnValue(result,i,USAGE_MOD_TIME);
		usage.deleted = KCIResultGetColumnValue(result,i,USAGE_DELETED);
...
static buf_t *_pack_archive_cluster_usage(KCIResult *result, char *cluster_name,
					  uint32_t cnt, uint32_t usage_info,
					  time_t *period_start)
{
	int i = 0;
	...
	for (i = 0; i < cnt; i++) {
		if (period_start && !*period_start)
			*period_start = slurm_atoul(KCIResultGetColumnValue(result,i,CLUSTER_START));

		memset(&usage, 0, sizeof(local_cluster_usage_t));

		usage.tres_id = KCIResultGetColumnValue(result,i,CLUSTER_TRES);
		usage.time_start = KCIResultGetColumnValue(result,i,CLUSTER_START);
		usage.tres_cnt = KCIResultGetColumnValue(result,i,CLUSTER_CNT);
		usage.alloc_secs = KCIResultGetColumnValue(result,i,CLUSTER_ACPU);
		usage.down_secs = KCIResultGetColumnValue(result,i,CLUSTER_DCPU);
		usage.pdown_secs = KCIResultGetColumnValue(result,i,CLUSTER_PDCPU);
		usage.idle_secs = KCIResultGetColumnValue(result,i,CLUSTER_ICPU);
		usage.plan_secs = KCIResultGetColumnValue(result,i,CLUSTER_PCPU);
		usage.over_secs = KCIResultGetColumnValue(result,i,CLUSTER_OCPU);
		usage.creation_time = KCIResultGetColumnValue(result,i,CLUSTER_CREATION_TIME);
		usage.mod_time = KCIResultGetColumnValue(result,i,CLUSTER_MOD_TIME);
		usage.deleted = KCIResultGetColumnValue(result,i,CLUSTER_DELETED);
			       ...
			       char *sql_table, uint32_t usage_info)
{
	...
	buf_t *buffer;
	int error_code = 0;
	buf_t *(*pack_func)(KCIResult *result, char *cluster_name,
			    uint32_t cnt, uint32_t usage_info,
			    time_t *period_start);
	...
	DB_DEBUG(DB_ARCHIVE, kingbase_conn->conn, "query\n%s", query);
	...
	if (!(cnt = KCIResultGetRowCount(result))) {
		KCIResultDealloc(result);
		return 0;
	}
 ...
 * Returns SLURM_ERROR for kingbase error, 0 no purge'able records found,
 * 1 found purgeable record.
 */
static int _get_oldest_record(kingbase_conn_t *kingbase_conn, char *cluster,
			      ...
			      time_t period_end, time_t *record_start)
{
	...
	*record_start = slurm_atoul(KCIResultGetColumnValue(result,0,0));
	KCIResultDealloc(result);

	return 1; /* found one record */
}

static int _purge_hash_table(kingbase_conn_t *kingbase_conn, char *cluster_name,
			     ...
			     char *col_name)
{
	...
	while ((rc = kingbase_db_delete_affected_rows(kingbase_conn, query)) > 0) {
		/* Commit here every time since this could create a huge
			* transaction.
			*/
		if ((rc = kingbase_db_commit(kingbase_conn)))
	...
	if (rc != SLURM_SUCCESS) {
		...
		return SLURM_ERROR;
	} else if (kingbase_db_commit(kingbase_conn)) {
				...
				slurmdb_archive_cond_t *arch_cond)
{
	...
	while (1) {
		rc = _get_oldest_record(kingbase_conn, cluster_name, sql_table,
					purge_type, col_name,
		...
		if (SLURMDB_PURGE_ARCHIVE_SET(purge_attr)) {
			time_t start = 0;
			rc = _archive_table(purge_type, kingbase_conn,
		...
		case PURGE_CLUSTER_USAGE:
			query = xstrdup_printf(
				...
				"(select %s from `%s_%s` where %s <= %ld order by %s asc LIMIT %d)",
		 ...
		 * kingbase_db_delete_affected_rows will return < 0 on failure or
		 * 0 if no records are affected.
		 */
		if ((rc = kingbase_db_delete_affected_rows(
...
{  
	...
	query = xstrdup_printf("delete from `%s_%s` where job_db_inx not in"  
			       "(select job_db_inx from `%s_%s`) LIMIT %d",  
			       cluster_name, app_table, cluster_name,  
			       parent_table, MAX_PURGE_LIMIT);  
	...
	xfree(query);  
	if (rc != SLURM_SUCCESS) {  
		error("Couldn't remove orphaned data from %s table",  
		      app_table);  
		return SLURM_ERROR;  
	} else if (kingbase_db_commit(kingbase_conn)) {  
		error("Couldn't commit cluster (%s) purge", cluster_name);  
...
static int _execute_archive(kingbase_conn_t *kingbase_conn,
			    char *cluster_name,
			    slurmdb_archive_cond_t *arch_cond)
{
	int rc = SLURM_SUCCESS;
	...
	if (arch_cond->purge_event != NO_VAL) {
		if ((rc = _archive_purge_table(PURGE_EVENT, 0, kingbase_conn,
					       cluster_name, arch_cond)))
			return rc;
	}

	if (arch_cond->purge_suspend != NO_VAL) {
		if ((rc = _archive_purge_table(PURGE_SUSPEND, 0, kingbase_conn,
					       cluster_name, arch_cond)))
			return rc;
	}

	if (arch_cond->purge_step != NO_VAL) {
		if ((rc = _archive_purge_table(PURGE_STEP, 0, kingbase_conn,
					       cluster_name, arch_cond)))
			return rc;
	}

	if (arch_cond->purge_job != NO_VAL) {
		if ((rc = _archive_purge_table(PURGE_JOB, 0, kingbase_conn,
					       cluster_name, arch_cond)))
			return rc;
		/*
		 ...
		 */
		if ((rc = _purge_hash_table(kingbase_conn, cluster_name,
	...
	if (arch_cond->purge_resv != NO_VAL) {
		if ((rc = _archive_purge_table(PURGE_RESV, 0, kingbase_conn,
					       cluster_name, arch_cond)))
			return rc;
	}

	if (arch_cond->purge_txn != NO_VAL) {
		if ((rc = _archive_purge_table(PURGE_TXN, 0, kingbase_conn,
					       cluster_name, arch_cond)))
			return rc;
	}
	...
	if (arch_cond->purge_usage != NO_VAL) {
		...
		for (i = 0; i < DBD_ROLLUP_COUNT; i++) {
			...
			if ((rc = _archive_purge_table(
				     ...
				     kingbase_conn, cluster_name, arch_cond)))
			return rc;
...
extern int as_kingbase_jobacct_process_archive(kingbase_conn_t *kingbase_conn,
					    slurmdb_archive_cond_t *arch_cond)
{
	int rc = SLURM_SUCCESS;
	char *cluster_name = NULL;
	...
	if (arch_cond->job_cond && arch_cond->job_cond->cluster_list
		 ...
		 * don't keep the as_kingbase_cluster_list_lock locked
	...
	while ((cluster_name = list_next(itr))) {
		if ((rc = _execute_archive(kingbase_conn, cluster_name, arch_cond))
		    != SLURM_SUCCESS)
			break;
	}
	list_iterator_destroy(itr);
...
static int _load_data(char **data, kingbase_conn_t *kingbase_conn)
{
	int rc;
	...
	rc = kingbase_db_query_check_after(kingbase_conn, *data);
	xfree(*data);
				 ...
				 kingbase_conn_t *kingbase_conn)
{
	...
	DB_DEBUG(DB_ARCHIVE, kingbase_conn->conn,
	...
	while (rec_cnt_left) {
		...
		if ((error_code = _load_data(&data, kingbase_conn)))
			break;
...
extern int as_kingbase_jobacct_process_archive_load(
	kingbase_conn_t *kingbase_conn, slurmdb_archive_rec_t *arch_rec)
{
	char *data = NULL;
	int error_code = SLURM_SUCCESS;
	...
	xassert(kingbase_conn->flags & DB_CONN_FLAG_ROLLBACK);
	...
	if ((strlen(data) >= 12)
		...
		error_code = _load_data(&data, kingbase_conn);
	} else {
