/*****************************************************************************\
 *  accounting_storage_kingbase.h - accounting interface to as_kingbase header file.
 *****************************************************************************
...
#ifndef _HAVE_ACCOUNTING_STORAGE_KINGBASE_H
#define _HAVE_ACCOUNTING_STORAGE_KINGBASE_H

#include <string.h>
#include <stdlib.h>

/* we can't include common/slurm_xlator.h here since it contains
 * list_push and list_pop which arekingbase macros what for some reason
 ...
 * in accounting_storage_kingbase.c...
 *
...
#include "src/database/kingbase_common.h"
 ...
 * go off of.
 */
extern List as_kingbase_cluster_list;
extern List as_kingbase_total_cluster_list;
extern pthread_rwlock_t as_kingbase_cluster_list_lock;
