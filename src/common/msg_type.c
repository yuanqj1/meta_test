...
const static entry_t msg_types[] = {
	...
	ENTRY(REQUEST_CACHE_JOB_INFO),
	ENTRY(REQUEST_CACHE_JOB_USER_INFO),
	ENTRY(REQUEST_CACHE_JOB_INFO_SINGLE),
	ENTRY(REQUEST_CACHE_PARTITION_INFO),
	ENTRY(REQUEST_CACHE_NODE_INFO),
	ENTRY(REQUEST_CACHE_NODE_INFO_SINGLE),		
#endif
	...
	ENTRY(REQUEST_CANCEL_JOB_STEP_TO_COMM),
#endif
#ifdef __METASTACK_LOAD_ABNORMAL	
	ENTRY(REQUEST_JOB_STEP_DATA),
#endif
