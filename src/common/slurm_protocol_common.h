...
#define BASE_PROTOCOL_VERSION        0x00ff

#define META_3_2    0x0086
#define META_3_1    0x0085
#define META_3_0    0x0084
#define META_2_3    0x0083
#define META_2_2    0x0082
#define META_2_1    0x0081
#define META_2_0    0x0080

#define META_3_2_PROTOCOL_VERSION (SLURM_24_05_PROTOCOL_VERSION | META_3_2)
#define META_3_1_PROTOCOL_VERSION (SLURM_24_05_PROTOCOL_VERSION | META_3_1)
#define META_3_0_PROTOCOL_VERSION (SLURM_24_05_PROTOCOL_VERSION | META_3_0)
#define META_2_3_PROTOCOL_VERSION (SLURM_22_05_PROTOCOL_VERSION | META_2_3)
#define META_2_2_PROTOCOL_VERSION (SLURM_22_05_PROTOCOL_VERSION | META_2_2)
#define META_2_1_PROTOCOL_VERSION (SLURM_22_05_PROTOCOL_VERSION | META_2_1)
#define META_2_0_PROTOCOL_VERSION (SLURM_22_05_PROTOCOL_VERSION | META_2_0)

#define SLURM_PROTOCOL_VERSION META_3_2_PROTOCOL_VERSION
#define SLURM_ONE_BACK_PROTOCOL_VERSION SLURM_23_11_PROTOCOL_VERSION
#define SLURM_TWO_BACK_PROTOCOL_VERSION SLURM_23_02_PROTOCOL_VERSION
#define SLURM_MIN_PROTOCOL_VERSION META_2_0_PROTOCOL_VERSION
#else
...
#define SLURM_NO_THROTTLE_LOCK	SLURM_BIT(8)
#endif
#endif
