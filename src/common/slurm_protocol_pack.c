...
#endif 
	} else if (smsg->protocol_version >= META_3_1_PROTOCOL_VERSION) {
		packstr(msg->account, buffer);
		/* Remove alias_list 2 versions after 23.11 */
		packnull(buffer);
		packstr(msg->batch_host, buffer);
...
#ifdef __META_PROTOCOL
	else if (smsg->protocol_version >= SLURM_23_02_PROTOCOL_VERSION) {
		packstr(msg->account, buffer);
						    ...
						    buf_t *buffer)
{
	...
	if (smsg->protocol_version >= META_3_2_PROTOCOL_VERSION) {
		...
		safe_unpackstr(&tmp_ptr->app_version, buffer);  
		safe_unpack8(&tmp_ptr->app_source, buffer);  
#endif 
	} else if (smsg->protocol_version >= META_3_1_PROTOCOL_VERSION) {
		safe_unpackstr(&tmp_ptr->account, buffer);
		safe_unpackstr(&tmp_ptr->alias_list, buffer);
...
static void _pack_update_partition_msg(const slurm_msg_t *smsg, buf_t *buffer)
{
	...
	if(smsg->protocol_version >= META_3_0_PROTOCOL_VERSION){
		...
		packstr(msg->qos_char, buffer);
		pack16(msg->state_up, buffer);
	} else if (smsg->protocol_version >= META_2_3_PROTOCOL_VERSION) {
		packstr(msg->allow_accounts, buffer);
		packstr(msg->allow_alloc_nodes, buffer);
		packstr(msg->allow_groups, buffer);
		packstr(msg->allow_qos,    buffer);
		...
		packstr(msg->priority_weight_tres,   buffer);
#endif
	} else if (smsg->protocol_version >= META_2_1_PROTOCOL_VERSION) {
		packstr(msg->allow_accounts, buffer);
		packstr(msg->allow_alloc_nodes, buffer);
		packstr(msg->allow_groups, buffer);
		packstr(msg->allow_qos,    buffer);
...
#endif
#ifdef __METASTACK_NEW_AUTO_SUPPLEMENT_AVAIL_NODES
		safe_unpackstr(&tmp_ptr->standby_nodes, buffer);
		safe_unpackstr(&tmp_ptr->standby_node_parameters, buffer);
#endif	
#ifdef __METASTACK_PART_PRIORITY_WEIGHT
		safe_unpack16(&tmp_ptr->priority_favor_small,    buffer);
		safe_unpack32(&tmp_ptr->priority_weight_age,     buffer);
		safe_unpack32(&tmp_ptr->priority_weight_assoc,   buffer);
		safe_unpack32(&tmp_ptr->priority_weight_fs,      buffer);
		safe_unpack32(&tmp_ptr->priority_weight_js,      buffer);
		safe_unpack32(&tmp_ptr->priority_weight_part,    buffer);
		safe_unpack32(&tmp_ptr->priority_weight_qos,     buffer);
		safe_unpackstr(&tmp_ptr->priority_weight_tres, buffer);
#endif
	} else if (protocol_version >= SLURM_24_05_PROTOCOL_VERSION) {
		safe_unpackstr(&tmp_ptr->allow_accounts, buffer);
		safe_unpackstr(&tmp_ptr->allow_alloc_nodes, buffer);
	...
	uint16_t protocol_version)
{
	...
	*msg = tmp_ptr;
	...
	if ((protocol_version >= META_3_0_PROTOCOL_VERSION) &&
		...
		safe_unpackstr(&tmp_ptr->tres_per_task, buffer);
#ifdef __METASTACK_NEW_CUSTOM_EXCEPTION
		safe_unpackstr(&tmp_ptr->watch_dog, buffer);
#endif
	} else if (protocol_version >= SLURM_23_11_PROTOCOL_VERSION) {
		if (unpack_step_id_members(&tmp_ptr->step_id, buffer,
					   protocol_version) != SLURM_SUCCESS)
		...
		safe_unpackstr(&tmp_ptr->submit_line, buffer);
		safe_unpackstr(&tmp_ptr->tres_bind, buffer);
		if (tmp_ptr->tres_bind) {
			char *new_tres_bind = xstrdup_printf("gres:%s", tmp_ptr->tres_bind);
			xfree(tmp_ptr->tres_bind);
			tmp_ptr->tres_bind = new_tres_bind;
		}
		slurm_format_tres_string(&tmp_ptr->tres_bind, "gres");
		safe_unpackstr(&tmp_ptr->tres_freq, buffer);
...
#ifdef __METASTACK_NEW_CUSTOM_EXCEPTION
		safe_unpackstr(&tmp_ptr->watch_dog, buffer);
		safe_unpackstr(&tmp_ptr->watch_dog_script, buffer);
		safe_unpack32(&tmp_ptr->init_time, buffer);
		safe_unpack32(&tmp_ptr->period, buffer);
		safe_unpackbool(&tmp_ptr->enable_all_nodes, buffer);
		safe_unpackbool(&tmp_ptr->enable_all_stepds, buffer);
		safe_unpack32(&tmp_ptr->style_step, buffer);
#endif
#ifdef __METASTACK_OPT_APP
		safe_unpackstr(&tmp_ptr->app_name, buffer);  
		safe_unpackstr(&tmp_ptr->app_version, buffer);  
...
#endif
#ifdef __METASTACK_NEW_AUTO_SUPPLEMENT_AVAIL_NODES
		safe_unpackstr(&part->borrowed_nodes, buffer);
		safe_unpackstr(&part->standby_nodes, buffer);
		safe_unpackstr(&part->standby_node_parameters, buffer);
#endif
#ifdef __METASTACK_PART_PRIORITY_WEIGHT
		safe_unpack16(&part->priority_favor_small,    buffer);
		safe_unpack32(&part->priority_weight_age,     buffer);
		safe_unpack32(&part->priority_weight_assoc,   buffer);
		safe_unpack32(&part->priority_weight_fs,      buffer);
		safe_unpack32(&part->priority_weight_js,      buffer);
		safe_unpack32(&part->priority_weight_part,    buffer);
		safe_unpack32(&part->priority_weight_qos,     buffer);
		safe_unpackstr(&part->priority_weight_tres, buffer);														
#endif
	} else if (protocol_version >= SLURM_24_05_PROTOCOL_VERSION) {
		safe_unpackstr(&part->name, buffer);
		if (part->name == NULL)
			 ...
			 uint16_t protocol_version)
{
	...
	if (protocol_version >= META_3_2_PROTOCOL_VERSION) {
		...
		safe_unpack32(&job->pending_order, buffer);
#endif
#ifdef __METASTACK_OPT_MSG_OUTPUT
		safe_unpackstr(&job->reason_detail, buffer);
#endif
...
#ifdef __METASTACK_NEW_CUSTOM_EXCEPTION
static void
_pack_slurm_ctl_conf_watch_dog_msg(slurm_msg_t * msg, buf_t *buffer,
			 uint16_t protocol_version)
{
	xassert(msg);
#ifdef __META_PROTOCOL
...
static int
_unpack_watch_dog_info_members(watch_dog_record_t * watch_dog, buf_t *buffer,
			       uint16_t protocol_version)
{
#ifdef __META_PROTOCOL
	if (protocol_version >= META_3_0_PROTOCOL_VERSION ) {
		safe_unpackstr(&watch_dog->watch_dog, buffer);
		if (watch_dog->watch_dog == NULL)
			watch_dog->watch_dog = xmalloc(1);/* part->name = "" implicit */
		safe_unpackstr(&watch_dog->account,buffer);			
		safe_unpackstr(&watch_dog->script,buffer);
		safe_unpackstr(&watch_dog->describe,buffer);		
		safe_unpack32(&watch_dog->init_time, buffer);
		safe_unpack32(&watch_dog->period, buffer);
		safe_unpackbool(&watch_dog->enable_all_nodes, buffer);
		safe_unpackbool(&watch_dog->enable_all_stepds, buffer);
	} else if(protocol_version >= SLURM_24_05_PROTOCOL_VERSION ) {
		/* do nothing*/
	} else if(protocol_version >= SLURM_ONE_BACK_PROTOCOL_VERSION ) {
		/* do nothing*/
	...
	return SLURM_SUCCESS;
unpack_error:
     slurm_free_watch_dog_info_members(watch_dog);
	//free_slurm_conf_watch_dog(part);
	return SLURM_ERROR;
}
#endif
...
{  
	...
	slurm_ctl_conf_info_msg_app_t *app_msg;  
  
	app_msg = xmalloc(sizeof(slurm_ctl_conf_info_msg_app_t));  
	*msg = app_msg;  
	...
	if (protocol_version >= META_3_2_PROTOCOL_VERSION) {  
		...
		safe_xcalloc(app_msg->app_array, record_count,  
		             sizeof(app_record_t));  
		app_msg->record_count = record_count;  
		for (uint32_t i = 0; i < record_count; i++) {  
			if (_unpack_app_info_members(&app_msg->app_array[i],  
			                             buffer, protocol_version))  
				goto unpack_error;  
		}  
	}  
...
unpack_error:  
	slurm_free_app_info_msg(app_msg);  
	*msg = NULL;  
	return SLURM_ERROR;  
}  
...
static int _unpack_delete_app_msg(delete_app_msg_t **msg, buf_t *buffer,  
                                  uint16_t protocol_version)  
{  
	delete_app_msg_t *tmp_ptr = xmalloc(sizeof(delete_app_msg_t));  
	*msg = tmp_ptr;  
...
unpack_error:  
	slurm_free_delete_app_msg(tmp_ptr);  
	*msg = NULL;  
	return SLURM_ERROR;  
}  
			 ...
			 uint16_t protocol_version)
{
	...
	if (protocol_version >= META_3_0_PROTOCOL_VERSION) {
		...
		pack16(build_ptr->time_sync_check, buffer);
		pack16(build_ptr->time_sync_check_time_diff, buffer);
		pack16(build_ptr->time_sync_check_retry_count, buffer);
#endif
#ifdef __METASTACK_OPT_GRES_CONFIG
		pack16(build_ptr->slurmctld_load_gres, buffer);
#endif
#ifdef __METASTACK_OPT_SACCT_OUTPUT
		pack16(build_ptr->skip_save_sacct_again, buffer);
#endif
	} else if (protocol_version >= SLURM_24_05_PROTOCOL_VERSION) {
		pack_time(build_ptr->last_update, buffer);
...
#ifdef __METASTACK_NEW_CUSTOM_EXCEPTION
static int
_unpack_slurm_ctl_conf_watch_dog_msg(slurm_ctl_conf_info_msg_watch_dog_t **msg,
			   buf_t *buffer, uint16_t protocol_version)
{
	int i;
	watch_dog_record_t *watch_dog = NULL;

	xassert(msg);
	*msg = xmalloc(sizeof(slurm_ctl_conf_info_msg_watch_dog_t));
#ifdef __META_PROTOCOL
	if (protocol_version >= META_3_0_PROTOCOL_VERSION ) {
		safe_unpack32(&((*msg)->record_count), buffer);
		safe_unpack_time(&((*msg)->last_update), buffer);

		safe_xcalloc((*msg)->watch_dog_array, (*msg)->record_count,
				sizeof(watch_dog_record_t));
		watch_dog = (*msg)->watch_dog_array;

		/* load individual watch dog info */
		for (i = 0; i < (*msg)->record_count; i++) {
			if (_unpack_watch_dog_info_members(&watch_dog[i],
							buffer,
							protocol_version))
				goto unpack_error;
		}
	...
	return SLURM_SUCCESS;
unpack_error:
	slurm_free_ctl_conf_watch_dog(*msg);
	*msg = NULL;
	return SLURM_ERROR;
}
#endif
...
#endif
#ifdef __METASTACK_OPT_MSG_OUTPUT
		safe_unpackstr(&build_ptr->extra_msg_file, buffer);
#endif
#ifdef __METASTACK_NEW_RPC_RATE_LIMIT
...
#endif
#ifdef __METASTACK_OPT_PRIORITY_JOBSIZE
		safe_unpackstr(&build_ptr->priority_jobsize_maxvalue, buffer);
#endif
#ifdef __METASTACK_NEW_TIME_SYNC_CHECK
		safe_unpack16(&build_ptr->time_sync_check, buffer);
		safe_unpack16(&build_ptr->time_sync_check_time_diff, buffer);
		safe_unpack16(&build_ptr->time_sync_check_retry_count, buffer);
#endif
#ifdef __METASTACK_OPT_GRES_CONFIG
		safe_unpack16(&build_ptr->slurmctld_load_gres, buffer);
#endif
#ifdef __METASTACK_OPT_SACCT_OUTPUT
		safe_unpack16(&build_ptr->skip_save_sacct_again, buffer);
#endif
	} else if (protocol_version >= SLURM_24_05_PROTOCOL_VERSION) {
		/* unpack timestamp of snapshot */
		safe_unpack_time(&build_ptr->last_update, buffer);
...
#ifdef __METASTACK_NEW_TIME_PREDICT
		pack16(job_desc_ptr->predict_job, buffer);
#endif
#ifdef __METASTACK_NEW_CUSTOM_EXCEPTION
		packstr(job_desc_ptr->watch_dog, buffer);
#endif
...
#ifdef __METASTACK_NEW_TIME_PREDICT
		safe_unpack16(&job_desc_ptr->predict_job, buffer);
#endif	
#ifdef __METASTACK_NEW_CUSTOM_EXCEPTION
		safe_unpackstr(&job_desc_ptr->watch_dog, buffer);	
#endif
#ifdef __METASTACK_NEW_APPTYPE_RECOGNITION
					    ...
					    uint16_t protocol_version)
{
	...
	*msg_ptr = msg;
	...
	if (protocol_version >= META_3_2_PROTOCOL_VERSION) {
		...
		if (tmp_bool) {
#ifdef __METASTACK_NEW_AUTO_SUPPLEMENT_AVAIL_NODES
			if (job_record_unpack(&msg->job_ptr, 0, buffer, protocol_version) || 
				 !msg->job_ptr || !msg->job_ptr->node_bitmap) {
				goto unpack_error;
			} else {
				node_record_count = bit_size(msg->job_ptr->node_bitmap);
			}
#else
		    ...
		    uint16_t protocol_version)
{
	...
	if(protocol_version >= META_3_0_PROTOCOL_VERSION){
		jobacctinfo_pack_detial(msg->jobacct, protocol_version,
				PROTOCOL_TYPE_SLURM, buffer);
	} else if(protocol_version >= SLURM_24_05_PROTOCOL_VERSION) {
...
#ifdef __METASTACK_NEW_LOAD_ABNORMAL
	if(protocol_version >= META_3_0_PROTOCOL_VERSION){
		if (jobacctinfo_unpack_detial(&msg->jobacct, protocol_version,
			   ...
			   uint16_t protocol_version)
{
	...
	if (protocol_version >= META_3_2_PROTOCOL_VERSION) {
		...
		pack8(msg->app_source, buffer);  
#endif
	} else if (protocol_version >= META_3_1_PROTOCOL_VERSION) {
		pack32(msg->job_id, buffer);
		pack32(msg->het_job_id, buffer);
...
#ifdef __METASTACK_NEW_CUSTOM_EXCEPTION
		safe_unpackstr(&launch_msg_ptr->watch_dog,  buffer);
		safe_unpackstr(&launch_msg_ptr->watch_dog_script, buffer);
		safe_unpack32(&launch_msg_ptr->init_time, buffer);
		safe_unpack32(&launch_msg_ptr->period, buffer);
...
#endif
#ifdef __METASTACK_NEW_APPTYPE_RECOGNITION
		safe_unpackstr(&launch_msg_ptr->apptype, buffer);
#endif
#ifdef __METASTACK_BUG_UPDATE_JOB_ENV
		safe_unpackstr(&launch_msg_ptr->tres_per_task, buffer);
#endif
#ifdef __METASTACK_OPT_APP
		safe_unpackstr(&launch_msg_ptr->app_name, buffer);  
		safe_unpackstr(&launch_msg_ptr->app_version, buffer);  
		safe_unpack8(&launch_msg_ptr->app_source, buffer);  
#endif
	} else if (protocol_version >= META_3_1_PROTOCOL_VERSION) {
		safe_unpack32(&launch_msg_ptr->job_id, buffer);
		safe_unpack32(&launch_msg_ptr->het_job_id, buffer);
...
#ifdef __METASTACK_NEW_TIME_SYNC_CHECK
		if(protocol_version >= META_3_0_PROTOCOL_VERSION){
			pack_time(msg->ping_resp_time, buffer);
			pack32(msg->return_code, buffer);	
		}
#endif 
	} else if (protocol_version >= SLURM_MIN_PROTOCOL_VERSION) {
...
#ifdef __METASTACK_NEW_TIME_SYNC_CHECK
		if(protocol_version >= META_3_0_PROTOCOL_VERSION){
			safe_unpack_time(&msg->ping_resp_time, buffer);
			safe_unpack32(&msg->return_code, buffer);
		}else{
			msg->ping_resp_time = 0;
			msg->return_code = 0;
		}
#endif
	} else if (protocol_version >= SLURM_MIN_PROTOCOL_VERSION) {
...
pack_msg(slurm_msg_t const *msg, buf_t *buffer)
{
	...
	case RESPONSE_BUILD_WATCH_DOG_INFO:
		/* printf watch dog parameter printing of rpc */
		_pack_slurm_ctl_conf_watch_dog_msg((slurm_msg_t *)
						msg, buffer,
	...
	case REQUEST_CANCEL_JOB_STEP_TO_COMM:
#endif
...
unpack_msg(slurm_msg_t * msg, buf_t *buffer)
{
	...
	case RESPONSE_BUILD_WATCH_DOG_INFO:
		/* printf watch dog parameter printing of rpc */
		rc = _unpack_slurm_ctl_conf_watch_dog_msg((slurm_ctl_conf_info_msg_watch_dog_t
							**)
						& (msg->data), buffer,
						msg->protocol_version);
		break;
