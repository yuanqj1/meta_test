...
#ifdef __METASTACK_NEW_GRES_DCU
  { "SBATCH_DCUS", 'U' },
  { "SBATCH_DCU_BIND", LONG_OPT_DCU_BIND },
  { "SBATCH_DCU_FREQ", LONG_OPT_DCU_FREQ },
  { "SBATCH_DCUS_PER_NODE", LONG_OPT_DCUS_PER_NODE },
...
#ifdef __METASTACK_NEW_GRES_DCU
	if ((local_env->ntasks_per_dcu  != NO_VAL) &&
	    !env_array_overwrite_het_fmt(array_ptr, "SLURM_NTASKS_PER_DCU",
					 het_job_offset, "%u",
